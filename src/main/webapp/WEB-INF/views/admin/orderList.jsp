			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>${o.orderDate}</td>
						<%
							com.LiaoChengxin.model.Order o=(com.LiaoChengxin.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.LiaoChengxin.dao.UserDao userDao=new com.LiaoChengxin.dao.UserDao();
						...
						<%
							...
							String paymentType=com.LiaoChengxin.model.Payment.findByPaymentId(con,n);
							 %>
